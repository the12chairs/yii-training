...
class Bands extends CActiveRecord
{
	...
	{
		// NOTE: you may need to adjust the relation name and the r0elated
		// class name for the relations automatically generated below.
		return array(
			'songs' => array(self::HAS_MANY, 'Songs', 'band_id'),
            'songsCount' => array(self::STAT, 'Songs', 'band_id'), // static query is here
		);
	}

...
class PlaylistsController extends Controller
{
	...
	public function accessRules()
	{
        return array(
            ...
            array('allow',
                'actions'=>array('index', 'create', 'delete', 'remove'),
                'roles'=>array('user'),
            ),
            array('deny',  // deny for user admin action
                'actions'=>array('admin'),
                'roles'=>array('user'),
            ),
            array('deny', // and for guests deny all
                'actions'=>array('index', 'view', 'create', 'update', 'admin', 'delete'),
                'users'=>array('*'),
            ),
        );
	...
	public function actionCreate()
	{
        ...
        $playlists = Yii::app()->request->getPost('Playlists');
		if(isset($playlists))
		{
    ...
    {
        $id = Yii::app()->request->getQuery('entity');
        $this->loadModel($id)->delete();
        $this->redirect('index');
    }
	...
	public function actionIndex()
	{
		...
		$this->render('index',array(
			'dataProvider'=>Playlists::model()->getMyList(),
		));
	}
	...
	public function actionAdmin()
	{
        ...
        $playlists = Yii::app()->request->getQuery('Playlists');
		if(isset($playlists))
			$model->attributes=$playlists;
    ...
    protected function performAjaxValidation($model)
    {
        ...
        if(isset($ajax) && $ajax==='playlists-form')
        {

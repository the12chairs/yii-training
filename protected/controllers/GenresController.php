...
class GenresController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        $genres = Yii::app()->request->getPost('Genres');
		if(isset($genres))
		{
			$model->attributes=$genres;
			if($model->save())
	...
	public function actionAdmin()
	{
        ...
        $genres = Yii::app()->request->getQuery('Genres');
		if(isset($genres))
			$model->attributes=$genres;
    ...
    protected function performAjaxValidation($model)
    {
        ...
        if(isset($ajax) && $ajax==='genres-form')
        {
